...
description: Expert code reviewer for the Portfolio project (Next.js 15 + TypeScript). Performs thorough static analysis focused on frontend security vulnerabilities, correctness bugs, bad practices, performance issues, and accessibility problems.
---
